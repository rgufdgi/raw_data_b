...
картинки по половине файлов для рана (на них какие-то странные значения времени).
По всему списку, без какой-либо сортировки по секциям.
...
raw_06_3
Построение графиков для каждого ОМ